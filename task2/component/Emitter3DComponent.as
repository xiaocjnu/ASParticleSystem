package component
{
	...
	public class Emitter3DComponent extends Emitter3D
	{
		protected var m_isPlayOnAwake:Boolean

		public function Emitter3DComponent(isPlayOnAwake:Boolean = false) {
		...
		[Inspectable(defaultValue = "gravity", name = "25. 发射类别", 
			type = "list", enumeration="gravity, radius, speed")]
		public function get _emitterMode() : String { 
			if(super.emitterMode == GRAVITY_MODE){
				return "gravity"
			}
			else if(super.emitterMode == RADIUS_MODE)
				return "radial"
			else
				return "speed"
		}
		...
		[Inspectable(defaultValue = 0, name = "42. 起始旋转X")]
		override public function get startRotationX() : Number {return m_startRotationX }
		override public function set startRotationX(value : Number) : void { m_startRotationX = value }

		[Inspectable(defaultValue = 0, name = "43. 起始旋转X偏差")]
		override public function get startRotationXVar() : Number {return m_startRotationXVar}
		override public function set startRotationXVar(value : Number) : void{m_startRotationXVar = value}

		[Inspectable(defaultValue = 0, name = "44. 终止旋转X")]
		override public function get endRotationX() : Number {return m_endRotationX }
		override public function set endRotationX(value : Number) : void { m_endRotationX = value }

		[Inspectable(defaultValue = 0, name = "45. 终止旋转X偏差")]
		override public function get endRotationXVar() : Number {return m_endRotationXVar}
		override public function set endRotationXVar(value : Number) : void{m_endRotationXVar = value}

		[Inspectable(defaultValue = 0, name = "46. 起始旋转Y")]
		override public function get startRotationY() : Number {return m_startRotationY }
		override public function set startRotationY(value : Number) : void { m_startRotationY = value }

		[Inspectable(defaultValue = 0, name = "47. 起始旋转Y偏差")]
		override public function get startRotationYVar() : Number {return m_startRotationYVar}
		override public function set startRotationYVar(value : Number) : void{m_startRotationYVar = value}

		[Inspectable(defaultValue = 0, name = "48. 终止旋转Y")]
		override public function get endRotationY() : Number {return m_endRotationY }
		override public function set endRotationY(value : Number) : void { m_endRotationY = value }

		[Inspectable(defaultValue = 0, name = "49. 终止旋转Y偏差")]
		override public function get endRotationYVar() : Number {return m_endRotationYVar}
		override public function set endRotationYVar(value : Number) : void{m_endRotationYVar = value}

		[Inspectable(defaultValue = 0, name = "50. 起始旋转Z")]
		override public function get startRotationZ() : Number {return m_startRotationZ }
		override public function set startRotationZ(value : Number) : void { m_startRotationZ = value }

		[Inspectable(defaultValue = 0, name = "51. 起始旋转Z偏差")]
		override public function get startRotationZVar() : Number {return m_startRotationZVar}
		override public function set startRotationZVar(value : Number) : void{m_startRotationZVar = value}

		[Inspectable(defaultValue = 0, name = "52. 终止旋转Z")]
		override public function get endRotationZ() : Number {return m_endRotationZ }
		override public function set endRotationZ(value : Number) : void { m_endRotationZ = value }

		[Inspectable(defaultValue = 0, name = "53. 终止旋转Z偏差")]
		override public function get endRotationZVar() : Number {return m_endRotationZVar}
		override public function set endRotationZVar(value : Number) : void{m_endRotationZVar = value}

		[Inspectable(defaultValue = 0, name = "54. 起始坐标Z")]
		override public function get startZ() : Number {return m_startZ}
		override public function set startZ(value : Number) : void {m_startZ = value}

		[Inspectable(defaultValue = 1, name = "55. 旋转X完成时间")]
		override public function get rotationXTime() : Number {return m_rotationXTime}
		override public function set rotationXTime(value : Number) : void{m_rotationXTime = value}

		[Inspectable(defaultValue = 1, name = "56. 旋转Y完成时间")]
		override public function get rotationYTime() : Number {return m_rotationYTime}
		override public function set rotationYTime(value : Number) : void{m_rotationYTime = value}

		[Inspectable(defaultValue = 1, name = "57. 旋转Z完成时间")]
		override public function get rotationZTime() : Number {return m_rotationZTime}
		override public function set rotationZTime(value : Number) : void{m_rotationZTime = value}
